...
<div class="container-fluid">
    ...
    <div class="flashing-panel">
        <h2>Просмотр объектов по необходимой общей площади</h2>
    </div>
    <div class="form-container">

<form method="get">
    <label for="Cena_2">Введите минимальную общую площадь</label>
    <input type="number" name="SO_1" min="0" max="1000" step="0.5">
    <row> м² </row>
    <label for="Cena_2">Введите максимальную общую площадь</label>
    <input type="number" name="SO_2" min="0" max="1000" step="0.5">
    <row> м² </row>
